...
- [ ] **M2 — Deterministic Combat (Workers)**  
       Server battle simulator + replay sync services. _Client-side fixed-tick combat loop, HUD sync, and currency plumbing landed; awaiting server worker implementation._
- [ ] **M3 — PvP + Resurrection**  
